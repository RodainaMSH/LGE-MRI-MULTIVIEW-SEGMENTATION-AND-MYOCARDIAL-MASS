...
from .normalization import SPADE, SPADELight
...
class VGG19(torch.nn.Module):
    def __init__(self, requires_grad=False):
        super().__init__()
        vgg_pretrained_features = torchvision.models.vgg19(weights=torchvision.models.VGG19_Weights.IMAGENET1K_V1).features  # was vgg19(pretrained=True); arg removed in torchvision>=0.15 — identical ImageNet weights
